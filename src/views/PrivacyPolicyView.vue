...
const lastUpdateDate = '30 January 2022'
</script>
...
<template>
  <MainLayout>
    <!-- Header Section -->
    <section
      class="flex flex-col justify-center items-center self-stretch p-20 w-full text-center text-gray-800 bg-x-lavender max-md:px-5 max-md:max-w-full"
    >
      <div class="flex flex-col max-w-full w-[302px]">
        <h1
          class="text-5xl font-bold tracking-tighter leading-none max-md:text-4xl mb-5"
        >
          Privacy Policy
        </h1>
        <p class="text-sm text-gray-500">Last Updated: {{ lastUpdateDate }}</p>
      </div>
    </section>
        ...
        <section>
          ...
          <div class="space-y-6">
            <p class="text-gray-600 leading-relaxed">
              ...
              hendrerit gravida rutrum quisque non. Sit amet nulla facilisi
              morbi tempus iaculis urna. Lorem sed risus ultricies tristique
              nulla aliquet enim. Volutpat blandit aliquam etiam erat velit.
              Orci eu lobortis elementum nibh. Ipsum suspendisse ultrices
